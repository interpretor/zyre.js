...
class Zyre extends EventEmitter {
  ...
  _createHandler() {
    this._connectHandler = (zyrePeer) => {
       ...
       */
      this.emit('connect', zyrePeer.getIdentity(), zyrePeer.getName(), zyrePeer.getHeaders());
    };
    ...
    this._disconnectHandler = (zyrePeer) => {
       ...
       * @property {string} name - Name of the peer
       */
      this.emit('disconnect', zyrePeer.getIdentity(), zyrePeer.getName());
    };
    ...
    this._expiredHandler = (zyrePeer) => {
       ...
       * @property {string} name - Name of the peer
       */
      this.emit('expired', zyrePeer.getIdentity(), zyrePeer.getName());
    };
    ...
    this._whisperHandler = (zyrePeer, content) => {
       ...
       */
      this.emit('whisper', zyrePeer.getIdentity(), zyrePeer.getName(), encodedContent);
    };
    ...
    this._shoutHandler = (zyrePeer, content, group) => {
       ...
       */
      this.emit('shout', zyrePeer.getIdentity(), zyrePeer.getName(), encodedContent, group);
    };
    ...
    this._joinHandler = (zyrePeer, group) => {
       ...
       */
      this.emit('join', zyrePeer.getIdentity(), zyrePeer.getName(), group);
    };
    ...
    this._leaveHandler = (zyrePeer, group) => {
       ...
       */
      this.emit('leave', zyrePeer.getIdentity(), zyrePeer.getName(), group);
    };
  }
